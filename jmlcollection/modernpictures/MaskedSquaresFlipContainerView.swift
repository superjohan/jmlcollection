//
//  MaskedSquaresFlipContainerView.swift
//  demo
//
...
class MaskedSquaresFlipContainerView: UIView {
    ...
    func animate() {
        UIView.animate(withDuration: ModernPicturesConstants.shapeAnimationDuration, delay: 0, options: [], animations: {
            self.square1.layer.transform = CATransform3DRotate(self.square1.layer.transform, CGFloat.pi, 1, 0, 0)
        }, completion: nil)
        
        UIView.animate(withDuration: ModernPicturesConstants.shapeAnimationDuration, delay: 0, options: [], animations: {
            self.square2.layer.transform = CATransform3DRotate(self.square1.layer.transform, CGFloat.pi, 0, 0, 1)
        }, completion: nil)
    }
}
