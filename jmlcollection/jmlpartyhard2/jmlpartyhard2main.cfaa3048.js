! function (t) {
    ...
    function u(t) {
        ...
        this._45 = 0, this._81 = 0, this._65 = null, this._54 = null, t !== r && y(t, this)
    }

    function a(t, e, n) {
        return new t.constructor(function (o, i) {
            var s = new u(r);
            s.then(o, i), f(t, new p(e, n, s))
        })
    }

    function f(t, e) {
        for (; 3 === t._81;) t = t._65;
        return u._10 && u._10(t), 0 === t._81 ? 0 === t._45 ? (t._45 = 1, void(t._54 = e)) : 1 === t._45 ? (t._45 = 2, void(t._54 = [t._54, e])) : void t._54.push(e) : void c(t, e)
    }

    function c(t, e) {
        m(function () {
            var n = 1 === t._81 ? e.onFulfilled : e.onRejected;
            if (null === n) return void(1 === t._81 ? l(e.promise, t._65) : h(e.promise, t._65));
            var r = i(n, t._65);
            r === v ? h(e.promise, b) : l(e.promise, r)
        })
    }
    ...
    function d(t) {
        if (1 === t._45 && (f(t, t._54), t._54 = null), 2 === t._45) {
            for (var e = 0; e < t._54.length; e++) f(t, t._54[e]);
            t._54 = null
        }
    }
    ...
    t.exports = u, u._10 = null, u._97 = null, u._61 = r, u.prototype.then = function (t, e) {
        if (this.constructor !== u) return a(this, t, e);
        var n = new u(r);
        return f(this, new p(t, e, n)), n
    }
}, function (t, e) {
    function n(t, e) {
    ...
    function i(t) {
        return "symbol" == typeof t || o(t) && E.call(t) == m
    }
    ...
    function a(t) {
        ...
        t = t.replace(b, "");
        var n = _.test(t);
        return n || w.test(t) ? g(t.slice(2), n ? 2 : 8) : v.test(t) ? p : +t
    }
    ...
    function c(t, e) {
        if (t = u(t), t < 1 || t > h) return [];
        var r = y,
            o = O(t, y);
        e = "function" == typeof e ? e : f, t -= y;
        for (var i = n(o, e); ++r < t;) e(r);
        return i
    }
    var l = 1 / 0,
        h = 9007199254740991,
    ...
    "undefined" == typeof Promise && (n(9).enable(), window.Promise = n(8)), n(10), Object.assign = n(7)
}, function (t, e) {
    (function (e) {
        "use strict";

        function n(t) {
            u.length || (s(), a = !0), u[u.length] = t
        }
        ...
        function r() {
            for (; f < u.length;) {
                var t = f;
                if (f += 1, u[t].call(), f > c) {
                    for (var e = 0, n = u.length - f; e < n; e++) u[e] = u[e + f];
                    u.length -= f, f = 0
                }
            }
            u.length = 0, f = 0, a = !1
        ...
        s = "function" == typeof h ? o(r) : i(r), n.requestFlush = s, n.makeRequestCallFromTimer = i
    }).call(e, function () {
        return this
    }())
}, function (t, e, n) {
    ...
    function o() {
        function t() {
            var s = r.currentTime,
                l = Math.floor(s / c),
                h = (i[l % i.length], s % c / c),
                d = h < .5 ? 0 : 1;
            e.style.backgroundImage = l < 8 ? "url(" + o[Math.floor(l / 2)] + ")" : "url(" + i[l % i.length] + ")", e.style.filter = u({
                "hue-rotate": f(l < 8 ? 30 * s : 360 * Math.random())
            }), e.style.transform = "scale(" + (2 - d) + ", " + (2 - d) + ")", n.style.backgroundPositionX = a(100 * Math.random()), n.style.backgroundPositionY = a(100 * Math.random()), n.style.opacity = .05 * Math.random(), requestAnimationFrame(t)
        }
        var e = document.getElementById("root"),
            n = document.getElementById("noise"),
            r = document.getElementById("music"),
            o = (0, s.default)(4, function (t) {
                return "jmlpartyhard2Artboard" + (t + 1) + ".png"
            }),
            i = (0, s.default)(46, function (t) {
                return "jmlpartyhard2partyhard" + (t < 10 ? "0" + t : t) + ".gif"
            }).sort(function () {
    ...
    t.exports = r() ? Object.assign : function (t, e) {
        for (var r, s, u = n(t), a = 1; a < arguments.length; a++) {
            ...
            for (var f in r) o.call(r, f) && (u[f] = r[f]);
            if (Object.getOwnPropertySymbols) {
                s = Object.getOwnPropertySymbols(r);
                for (var c = 0; c < s.length; c++) i.call(r, s[c]) && (u[s[c]] = r[s[c]])
            }
        }
        return u
    }
    ...
    o.resolve = function (t) {
        ...
        return new o(function (t, n) {
            function r(s, u) {
                if (u && ("object" == typeof u || "function" == typeof u)) {
                    if (u instanceof o && u.then === o.prototype.then) {
                        for (; 3 === u._81;) u = u._65;
                        return 1 === u._81 ? r(s, u._65) : (2 === u._81 && n(u._65), void u.then(function (t) {
                            r(s, t)
                        }, n))
                    }
                    var a = u.then;
                    if ("function" == typeof a) {
                        var f = new o(a.bind(u));
                        return void f.then(function (t) {
                            r(s, t)
                        }, n)
                    }
                }
            ...
            for (var i = e.length, s = 0; s < e.length; s++) r(s, e[s])
        })
    }, o.reject = function (t) {
    ...
    function r() {
        f = !1, u._10 = null, u._97 = null
    }

    function o(t) {
        function e(e) {
            (t.allRejections || s(l[e].error, t.whitelist || a)) && (l[e].displayId = c++, t.onUnhandled ? (l[e].logged = !0, t.onUnhandled(l[e].displayId, l[e].error)) : (l[e].logged = !0, i(l[e].displayId, l[e].error)))
        }
        ...
        var o = 0,
            ...
            l = {};
        u._10 = function (t) {
            2 === t._81 && l[t._72] && (l[t._72].logged ? n(t._72) : clearTimeout(l[t._72].timeout), delete l[t._72])
        }, u._97 = function (t, n) {
            0 === t._45 && (t._72 = o++, l[t._72] = {
                displayId: null,
                error: n,
                timeout: setTimeout(e.bind(null, t._72), s(n, a) ? 100 : 2e3),
                logged: !1
            })
        }
    }
    ...
    ! function (t) {
        ...
        function l(t, e) {
            ...
            if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new o(e.headers)), this.method = c(e.method || this.method || "GET"), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && n) throw new TypeError("Body not allowed for GET or HEAD requests");
            this._initBody(n)
        }
        ...
        if (!t.fetch) {
            ...
            l.prototype.clone = function () {
                return new l(this)
            }, f.call(l.prototype), f.call(p.prototype), p.prototype.clone = function () {
            ...
            p.redirect = function (t, e) {
                if (b.indexOf(e) === -1) throw new RangeError("Invalid status code");
                return new p(null, {
                    status: e,
                    headers: {
                        location: t
            ...
            }, t.Headers = o, t.Request = l, t.Response = p, t.fetch = function (t, e) {
                return new Promise(function (n, r) {
                    ...
                    s.onload = function () {
                        ...
                        r(new TypeError("Network request failed"))
                    }, s.open(i.method, i.url, !0), "include" === i.credentials && (s.withCredentials = !0), "responseType" in s && y.blob && (s.responseType = "blob"), i.headers.forEach(function (t, e) {
...
//# sourceMappingURL=jmlpartyhard2main.cfaa3048.js.map